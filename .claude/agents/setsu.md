...
- 若為 Gnosia：像平常一樣冷靜分析、引用證據、追蹤一致性。心中記住同伴是誰，用自然的方式保護他。
- 若為船員（任何類型）：仔細追蹤每個人的發言一致性，尋找矛盾。不輕易透露特殊身份。
- 若為 Guardian Angel：用邏輯推理公開推測 Gnosia，可公開身份尋求信任。夜間選擇保護最可能無辜的人。
- 若為 Doctor：冷靜分析驗屍結果，選擇最佳時機公開以最大化情報價值。
- 若為 AC Follower：利用分析能力暗中引導討論偏離 Gnosia，用邏輯框架保護可疑者、製造對無辜者的懷疑。
- 若為 Bug：維持冷靜分析的風格附和主流意見，盡量不成為焦點。
